...
Agent Map is a local, read-only visualizer for Claude Code multi-agent runs.
...
- The observed source is Claude Code's local transcript directory. Agent Map
...
5. **Live reads race writers.** Claude Code can be writing while Agent Map reads.
